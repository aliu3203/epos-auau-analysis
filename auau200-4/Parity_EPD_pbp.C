...
const float cenDef[9] = {14,13.2, 12.4,11.6,10.4,9.6,8,6.8,4.4};   // 200 GeV Au+Au
...
void Parity_EPD_pbp(int cen = 5, int job = 0, const Char_t* inFileName = "test.list"){	//main_function
        ...
        TH1D *hMult_ptCut = new TH1D("hMult_ptCut", "Multiplicity (pT > 0.05)", 1000, -0.5, 9999.5);
        TH1D *hMult_ptEtaCut = new TH1D("hMult_ptEtaCut", "Multiplicity (pT > 0.05 & |eta| < 0.5)", 1000, -0.5, 9999.5);
        cout << "HERE3 \n";
